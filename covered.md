...
| 2026-07-07 | claude-code | 에이전트 스킬·플러그인 생태계(Superpowers 등)                                             |
...
| 2026-07-23 | claude-code | 서브에이전트 세션 예산 상한과 백그라운드 에이전트 자율 커밋·PR                            |
| 2026-07-23 | ai-concept  | 에이전트 메모리 벤치마크(LoCoMo)와 토큰 효율 메모리                                       |
| 2026-07-23 | audit       | 딜로이트 Zora AI와 에이전틱 재무 자동화                                                   |
| 2026-07-23 | trend       | OpenAI 프레즌스(Presence)와 신뢰형 엔터프라이즈 에이전트                                  |
